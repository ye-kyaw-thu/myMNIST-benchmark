...
def main():
    parser = argparse.ArgumentParser(description='MLP Baseline for MNIST')
    ...
    parser.add_argument('--output', type=str, default='mlp_results', help='Output directory')
